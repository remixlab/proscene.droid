...
public class MouseAgent extends GenericWheeledBiMotionAgent<GenericMotionProfile<Constants.DOF2Action>> {
	 ...
	 * Only meaningful for 3D Scenes. Default bindings are defined as follows:
	 * <p>
	...
	/*
	 * Set the default InteractiveFrame mouse bindings for the camera in third person mode.
	 * Only meaningful for 3D Scenes. Default bindings are defined as follows:
	 * <p>
	 * Left button -> MOVE_FORWARD<br>
	 * Center button -> LOOK_AROUND<br>
	...
	/*
	 * Set the default mouse bindings for the Eye to rotate around a point
	 * (typically scene center) as follows:
	 * <p>
