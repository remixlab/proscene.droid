 ...
 * depend on the platform your running your code. In Java, for instance, have a look at:
 * http://docs.oracle.com/javase/7/docs/api/java/awt/event/KeyEvent.html to get some VK_* values. You may use these
 * values in your code to freely chosse them as a convention in your code. Have a look at the CameraCustomization
 * example.
 */
public class KeyboardEvent extends TerseEvent {
	...
	/**
	 * Returns the character key defining the events keyboardshortcut. It may be null meaning that the keyboard is of the
	...
	/**
	 * Returns the key code defining the events keyboardshortcut. It may be null meaning that the keyboard is of the
	 * shape: {@link #key()}.
	 */
