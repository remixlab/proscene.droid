 ...
 * Grabbers are attached to {@link remixlab.tersehandling.core.Agent}s
 * through their API, and may be attached to more than just a single Agent.
 * <p>
 * Each application object willing to subscribe a set of actions should
 * either implement the Grabbable interface or extend from the {@link remixlab.tersehandling.core.AbstractGrabber}
 * class (which provides a default implementation of that interface),
