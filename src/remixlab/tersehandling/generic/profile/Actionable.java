 ...
 * 
 * The interface expects to be parameterized with the global enum action set, and then defining a one-to-one mapping
 * among the local subset and the global set.
 * 
 * @param <E>
