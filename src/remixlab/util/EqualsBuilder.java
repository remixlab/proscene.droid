 ...
 * href="http://java.sun.com/docs/books/effective/index.html">Effective Java</a> , by Joshua Bloch. In particular the
 * rule for comparing <code>doubles</code>, <code>floats</code>, and arrays can be tricky. Also, making sure that
...
public class EqualsBuilder {
	 ...
	 * </p>
	 * 
	 * @return <code>true</code> if all of the fields that have been checked are equal, <code>false</code> otherwise.
	 * 
	 * @since 3.0
	 */
