...
/**
 * An Agent is a high-level {@link remixlab.bogusinput.event.BogusEvent} parser, which holds a {@link #pool()} of
 * grabbers: application objects implementing (user-defined) actions to be triggered from a
 * {@link remixlab.bogusinput.event.BogusEvent} (by means of the {@link remixlab.bogusinput.core.Grabbable} interface).
 * <p>
 ...
 * in the pool will then check if the {@link remixlab.bogusinput.core.Grabbable#checkIfGrabsInput(BogusEvent)})
 ...
 * generic, agents also hold {@link remixlab.bogusinput.generic.profile.Profile}s, each containing a mapping between
...
public class Agent {
	 ...
	 * {@link remixlab.bogusinput.core.Grabbable#checkIfGrabsInput(BogusEvent)}) condition is met. The first object
	...
	/**
	 * Calls {@link remixlab.bogusinput.core.InputHandler#enqueueEventTuple(EventGrabberTuple)} to enqueue the
	 * {@link remixlab.bogusinput.core.EventGrabberTuple} for later execution.
	 * <p>
	 ...
	 * {@link remixlab.bogusinput.core.InputHandler#handle()}).
	 * <p>
	 * See the Space Navigator example.
	 * 
	 * @see remixlab.bogusinput.core.InputHandler#handle()
	 */
	...
	/**
	 * Returns the {@link remixlab.bogusinput.core.InputHandler} this agent is registered to.
	 */
	 ...
	 * {@link remixlab.bogusinput.core.Grabbable#grabsAgent(Agent)}.
	 */
	 ...
	 * {@link remixlab.bogusinput.core.Grabbable#checkIfGrabsInput(BogusEvent)} on this grabber. Use
	 ...
	 * {@link remixlab.bogusinput.core.Grabbable#checkIfGrabsInput(BogusEvent)} by the handler, and hence can no longer
