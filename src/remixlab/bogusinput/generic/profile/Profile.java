...
public class Profile<K extends Shortcut, A extends Action<?>> implements EventConstants, Copyable {
	 ...
	 * 
	 * @param event
	 *          {@link remixlab.bogusinput.generic.event.ActionBogusEvent} i.e., Action event to be parsed by this
	 *          profile.
	...
	/**
	 * Returns the {@link remixlab.bogusinput.core.Action} binding for the given
	 * {@link remixlab.bogusinput.event.shortcut.Shortcut} key.
	 */
