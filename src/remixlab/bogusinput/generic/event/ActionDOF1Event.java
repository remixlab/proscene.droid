...
import remixlab.bogusinput.event.DOF1Event;

/**
 * Generic version of {@link remixlab.bogusinput.event.DOF1Event}.
 * <p>
...
public class ActionDOF1Event<A extends Action<?>> extends DOF1Event implements ActionBogusEvent<A> {
	...
	/**
	 * Convenience constructor that calls the equivalent {@link remixlab.bogusinput.event.DOF1Event} one.
	 */
	...
	/**
	 * Convenience constructor that calls the equivalent {@link remixlab.bogusinput.event.DOF1Event} one and then attaches
