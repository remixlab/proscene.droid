...
/**
 * Generic version of {@link remixlab.bogusinput.event.DOF2Event}.
 * <p>
...
public class ActionDOF2Event<A extends Action<?>> extends DOF2Event implements ActionBogusEvent<A> {
	...
	/**
	 * Convenience constructor that calls the equivalent {@link remixlab.bogusinput.event.DOF2Event} one.
	 */
	...
	/**
	 * Convenience constructor that calls the equivalent {@link remixlab.bogusinput.event.DOF2Event} one and then attaches
