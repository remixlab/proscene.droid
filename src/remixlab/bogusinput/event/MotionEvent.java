...
/**
 * Base class of all DOF_n_Events: {@link remixlab.bogusinput.event.BogusEvent}s defined from DOFs (degrees-of-freedom).
 * <p>
 * A MotionEvent encapsulates a {@link remixlab.bogusinput.event.shortcut.ButtonShortcut}. MotionEvents may be relative
...
public class MotionEvent extends BogusEvent {
	...
	/**
	 * Constructs a MotionEvent with an "empty" {@link remixlab.bogusinput.event.shortcut.ButtonShortcut}.
	 */
	public MotionEvent() {
		super();
	 ...
	 * {@link remixlab.bogusinput.event.shortcut.ButtonShortcut}.
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see remixlab.bogusinput.event.BogusEvent#get()
	 */
	@Override
	...
	/*
	 * Returns the button defining the event's {@link remixlab.bogusinput.event.shortcut.ButtonShortcut}.
	 */
	public int button() {
		return button;
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see remixlab.bogusinput.event.BogusEvent#shortcut()
	 */
	@Override
