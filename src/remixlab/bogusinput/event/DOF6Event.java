...
/**
 * A {@link remixlab.bogusinput.event.MotionEvent} with six degrees-of-freedom ({@link #x()}, {@link #y()}, {@link #z()}
...
public class DOF6Event extends MotionEvent {
	...
	/**
	 * Reduces the event to a {@link remixlab.bogusinput.event.DOF3Event} (lossy reduction).
	 * 
