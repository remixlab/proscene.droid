...
/**
 * A keyboard event is a {@link remixlab.bogusinput.event.BogusEvent} specialization that encapsulates a
 * {@link remixlab.bogusinput.event.shortcut.KeyboardShortcut}. Keyboard shortcuts may be of one form out of two: 1. A
 * single Character; or, 2. A modifier mask (such as: (TH_ALT | TH_SHIFT)) plus a virtual.
 * <p>
 ...
 * You may use these values to freely choose them as a convention in your code. Have a look at the CameraCustomization
 * example.
 */
public class KeyboardEvent extends BogusEvent {
	 ...
	 * {@link remixlab.bogusinput.event.shortcut.KeyboardShortcut}.
	 */
	...
	/**
	 * Constructs a keyboard event with <b>c</b> defining its {@link remixlab.bogusinput.event.shortcut.KeyboardShortcut}.
	 */
