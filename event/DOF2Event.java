...
/**
 * A {@link remixlab.bogusinput.event.MotionEvent} with two degrees-of-freedom ({@link #x()} and {@link #y()}).
 */
public class DOF2Event extends MotionEvent {
	...
	/**
	 * Reduces the event to a {@link remixlab.bogusinput.event.DOF1Event} (lossy reduction).
	 * 
	 * @param fromX
