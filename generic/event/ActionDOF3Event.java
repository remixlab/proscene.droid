...
import remixlab.bogusinput.event.DOF3Event;

/**
 * Generic version of {@link remixlab.bogusinput.event.DOF3Event}.
 * <p>
...
public class ActionDOF3Event<A extends Action<?>> extends DOF3Event implements ActionBogusEvent<A> {
	...
	/**
	 * Convenience constructor that calls the equivalent {@link remixlab.bogusinput.event.DOF3Event} one.
	 */
	...
	/**
	 * Convenience constructor that calls the equivalent {@link remixlab.bogusinput.event.DOF3Event} one and then attaches
