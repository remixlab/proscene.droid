...
/**
 * A {@link remixlab.bogusinput.generic.agent.ActionAgent} with an extra
 * {@link remixlab.bogusinput.generic.profile.ClickProfile} defining
 * {@link remixlab.bogusinput.event.shortcut.ClickShortcut} -> {@link remixlab.bogusinput.core.Action} mappings.
 * <p>
...
public class ActionMotionAgent<M extends MotionProfile<?>, C extends ClickProfile<?>> extends
	...
	/**
	 * Sets the {@link remixlab.bogusinput.generic.profile.MotionProfile}
	 */
	...
	/**
	 * Returns the {@link remixlab.bogusinput.generic.profile.ClickProfile} instance.
	 */
	...
	/**
	 * Sets the {@link remixlab.bogusinput.generic.profile.ClickProfile}
	 */
	...
	/**
	 * Set dof1 sensitivity value which is needed by {@link remixlab.bogusinput.event.MotionEvent#modulate(float[])}.
	 */
	 ...
	 * {@link remixlab.bogusinput.event.MotionEvent#modulate(float[])}.
	 */
	...
	/**
	 * Returns the sensitivities that modulate the {@link remixlab.bogusinput.event.MotionEvent}
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see remixlab.bogusinput.generic.agent.ActionAgent#info()
	 */
	@Override
	public String info() {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see remixlab.bogusinput.generic.agent.ActionAgent#handle(remixlab.bogusinput.event.BogusEvent)
	 */
	@Override
